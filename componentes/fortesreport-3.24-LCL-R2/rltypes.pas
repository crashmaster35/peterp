...
type
  TRLPaperInfo=record
    ...
    // texto descritivo
    Description:string;
    // tamanho emulado (enviado como custom para a impressora)
    Emulated   :boolean;
    // código de plataforma para o tipo do papel
...
{@func PaperSizeBySize - Retorna o tipo de papel que mais se aproxima do tamanho informado em milímetros. :/}
...
function PaperSizeSize(PaperSize:TRLPaperSize):TRLPaperInfo;
begin
end;

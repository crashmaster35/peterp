...
type
  ...
  published
    ...
    // descended from TAboutComponent
...
begin
  RegisterPropertyEditor(TypeInfo(TAboutbox),
    TAboutComponent, 'About', TAboutPropertyEditor);
end;
...
procedure TAboutComponent.SetMyComponentName(Const Avalue:String);
begin
    fAboutBox.ComponentName:=AValue;
    fAboutBox.Title:=AValue;
end;
procedure TAboutComponent.SetAboutBoxWidth(Const AValue:Integer);
begin
    fAboutBox.Width:=Avalue;
end;
procedure TAboutComponent.SetAboutBoxHeight(Const AValue:Integer);
begin
  fAboutBox.Height:=Avalue;
end;
procedure TAboutComponent.SetAboutBoxDescription(Const AValue:String);
begin
  fAboutBox.Description.Clear;
  fAboutBox.Description.Add(AValue);
end;
procedure TAboutComponent.SetAboutBoxFontName(Const AValue:String);
begin
  fAboutBox.Font.Name:=AValue;
end;
procedure TAboutComponent.SetAboutBoxFontSize(Const AValue:Integer);
begin
  if (AValue > 6) then fAboutBox.Font.Size:=AValue;
end;
procedure TAboutComponent.SetAboutBoxTitle(Const AValue:String);
begin
   fAboutBox.Title:=AValue;
end;
procedure TAboutComponent.SetAboutBoxBitmap(Const AValue:TBitmap);
begin
  If Assigned(Avalue) then fAboutBox.Assign(AValue);
end;
procedure TAboutComponent.SetAboutBoxBackgroundColor(Const AValue:TColor);
begin
    fAboutBox.BackGroundColor:=AValue;;
end;
procedure TAboutComponent.SetAboutBoxVersion(Const AValue:String);
begin
   fAboutBox.Version:=AValue;
end;
procedure TAboutComponent.SetAboutBoxAuthorname(Const AValue:String);
begin
   fAboutBox.Authorname:=AValue;
end;
procedure TAboutComponent.SetAboutBoxOrganisation(Const AValue:String);
begin
   fAboutBox.Organisation:=AValue;
end;
procedure TAboutComponent.SetAboutBoxAuthorEmail(Const AValue:String);
begin
   fAboutBox.AuthorEmail:=AValue;
end;
procedure TAboutComponent.SetAboutBoxBackgroundResourceName(Const AValue:String);
begin
   fAboutBox.BackgroundResourceName:=AValue;
end;
procedure TAboutComponent.SetAboutBoxLicenseType(Const AValue:string);
begin
...
procedure TAboutComponent.SetAboutBoxStretchBackgroundImage(Const AValue:Boolean);
begin
...
constructor TAboutComponent.Create(AOwner: TComponent);
var
  TempImage: TPicture;
  r:TLResource;
begin
  ...
  begin
    ...
    // Default of TAboutComponent values override TAbouBox.Create defaults
    ComponentName := 'TAboutComponent';
    Description.Add('This is to demonstrate'); //TStrings
    Description.Add('the use of TAboutComponent'); //TStrings
...
destructor TAboutComponent.Destroy;
begin

...
begin
  ...
  begin
    ...
    repeat
      ...
      FDecompressRec.next_in := {$ifdef FPC} @buffer[0];  {$else} Buffer; {$endif}
      ...
      begin
        ...
        FDecompressRec.next_out := {$ifdef FPC} Pbytef(FRecvBuf) + FRecvCount; {$else} PChar(FRecvBuf) + FRecvCount;{$endif}
...
begin
  ...
  begin
    ...
    begin
      FCompressRec.next_out :=  {$ifdef FPC} @buffer[0];  {$else} Buffer; {$endif}
